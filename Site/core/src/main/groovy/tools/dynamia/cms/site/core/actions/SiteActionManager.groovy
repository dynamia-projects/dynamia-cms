...
public class SiteActionManager {
    ...
    public static void performAction(String actionName, ModelAndView mv, Object data) {
    ...
    public static void performAction(String actionName, ModelAndView mv, HttpServletRequest request, RedirectAttributes redirectAttributes,
            Object data) {
    ...
    public static ActionEvent newEvent(Site site, ModelAndView mv, HttpServletRequest request, RedirectAttributes redirectAttributes,
            Object source, Object data) {
        return new ActionEvent(site, mv, request, null, redirectAttributes, source, data);
    }

    public static ActionEvent newEvent(Site site, ModelAndView mv, HttpServletRequest request, HttpServletResponse response, Object source,
            Object data) {
        return new ActionEvent(site, mv, request, response, null, source, data);
    }

    public static ActionEvent newEvent(Site site, ModelAndView mv, HttpServletRequest request, HttpServletResponse response,
