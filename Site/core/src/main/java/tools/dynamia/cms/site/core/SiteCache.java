...
public class SiteCache {
	...
	public Object get(Site site, String key) {
	...
	public Object get(ActionEvent evt, String keysalt) {
		String key = key(evt, keysalt);
		return get(evt.getSite(), key);
	}

	public Object get(Site site, HttpServletRequest request, String keysalt) {
		String key = key(site,request, keysalt);
		return get(site, key);
	}

	public void put(Site site, String key, Object object) {
		Cache cache = cacheManager.getCache(CACHE_NAME);
	 ...
	 * @param object
	 */
	public void put(ActionEvent evt, String keysalt, Object object) {
	 ...
	 * @param object
	 */
	public void put(Site site, HttpServletRequest request, String keysalt, Object object) {
		String key = key(site, request, keysalt);
		put(site, key, object);
	}
	 ...
	 * @return
	 */
	public String key(Site site, HttpServletRequest request, String keysalt) {
	 ...
	 * @return
	 */
	public String key(ActionEvent evt, String keysalt) {
		StringBuilder keybuilder = new StringBuilder();
	...
	public String key(Site site, String key) {
